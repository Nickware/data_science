...
- **Kernel CUDA `actualizarPartículas`:**  
  - Cálculo paralelo para todas las partículas.  
...
- **Inicialización:**  
  - Las partículas se posicionan inicialmente solo en la mitad izquierda (0 a 1 en x).  
  - Las velocidades se generan en el rango $[-1.5, 1.5]$.

***

### Proceso de simulación

1. Reservar memoria de GPU.
2. Inicializar partículas en CPU.
3. Copiar datos a GPU.
4. Ejecutar el kernel CUDA para cada frame, actuando en paralelo.
